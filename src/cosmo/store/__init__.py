"""Trend + findings store and compliance mapping (architecture §14, §15).
...
the noisiest-rules signal back into the §10 skills loop, hold the coordinated-
disclosure queue (§13), and roll findings up to OWASP Top 10 for compliance.
"""
