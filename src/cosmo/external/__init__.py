"""Authorized external-target mode (build step 19).

Testing a live target the user is separately authorized to test. The enforcement
already lives in the egress broker (step 7) — mode gate, resolved-host
...
mode. There is no code path from sandbox/fuzz testing into this mode:
